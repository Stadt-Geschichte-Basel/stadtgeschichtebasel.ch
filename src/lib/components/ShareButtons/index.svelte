...
<div class="btn-group">
	{#if webShareAPISupported}
		<button class=" variant-filled-primary btn mr-4 cursor-pointer" on:click={handleWebShare}>
			Teilen
			<svg aria-hidden="true" fill="white" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6"
	...
	{:else}
		<a
			class=" variant-filled-primary btn mr-4 cursor-pointer"
